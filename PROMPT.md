...
Build a library like [nanotags](https://nanotags.psdcoder.dev/), but that uses
[alien-signals](https://github.com/stackblitz/alien-signals) for reactivity
instead of `nanostore`s.
